...
public class ConnectionTest {
    @Test //其中，配置文件声明在工程的src目录下：【jdbc.properties】
    ...
    @Test//说明：不必显式的注册驱动了。因为在DriverManager的源码中已经存在静态代码块，实现了驱动的注册。
    ...
    @Test//说明：使用DriverManager实现数据库的连接。体会获取连接必要的4个基本要素。
